...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument("--data_Dir", default='/home/linlilang/pose-gan/data/', help="Directory with annotations and data")
    ...
    def parse(self):
        ...
        self.opt.pairs_file_train_interpol = self.opt.data_Dir + self.opt.dataset + '-pairs-train.csv'
        self.opt.pairs_file_test_interpol = self.opt.data_Dir + self.opt.dataset + '-pairs-test.csv'

        self.opt.tmp_pose_dir = '/mnt/ssd2/linlilang/tmp/' + self.opt.dataset + '/'
